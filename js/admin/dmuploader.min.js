...
(function($) {
 ...
 // These are the plugin defaults values
  ...
  DmUploader.prototype.newData = function(data)
  {
  ...
  DmUploader.prototype.queueFiles = function(files)
  {
    ...
    for (var i= 0; i < files.length; i++)
    {
      ...
      this.settings.onNewFile.call( this.element, index, file, this.element.attr("type") );
  ...
  DmUploader.prototype.processQueue = function()
  {
    ...
    var typeUpload = this.element.attr("type");
    this.newData( {type: typeUpload} );

    if( typeUpload == 2 ) {

      var activeUploader = this.element.find(".active-uploader");
      this.newData( { id: activeUploader.parent(".work").attr("compare"), image: activeUploader.attr("image") } );
